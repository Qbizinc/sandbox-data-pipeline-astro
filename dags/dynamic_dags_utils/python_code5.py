...
def main(expand=None, **kwargs):
    ...
    data_grp_pd = data_pd.set_index(kwargs['grp_vars'] + ['quarter']) \
    ...
    models_dict = {item: xgb.XGBRegressor(n_estimators = 10,
    ...
    for item in index_list:
        score = train_model(item, lagged_pd, kwargs['grp_vars'],
                            models_dict, categories_dict)
